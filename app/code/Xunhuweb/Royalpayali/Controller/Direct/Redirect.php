...
namespace Xunhuweb\Royalpayali\Controller\Direct;

use Magento\Framework\App\Action\Action;
use Xunhuweb\Royalpayali\Model\Royalpayali as RoyalpayaliCode;
...
{
    /**
     * @var \Xunhuweb\Royalpayali\Model\Api\RedirectApi
     */
   // protected $_api;
    ...
    public function execute()
    {
        ...
        if($this->is_wechat_client()){
            ...
            <html>
                ...
                <?php 
                	if($this->isIOS()){
                		?>
                		<img alt="支付宝" src="<?php echo $this->assetRepo->getUrl('Xunhuweb_Royalpayaliali::images/ios.png')?>" style="max-width: 100%;">
                		<?php 
                	}else{
                		?>
                		<img alt="支付宝" src="<?php echo $this->assetRepo->getUrl('Xunhuweb_Royalpayaliali::images/alipayout.jpg')?>" style="max-width: 100%;">
                		<?php 
                	}
                ?>
                </body>
        ...
        try {
            ...
            if ($this->_quote->getId()) {
                ...
                if (!$this->_quote->getGrandTotal()) {
                    throw new \Magento\Framework\Exception\LocalizedException(
                        __(
                            'Royalpayali can\'t process orders with a zero balance due. '
            ...
            if($this->is_app_client()){
                $channel='Alipay';
                $api_uri ='https://mpay.royalpay.com.au//api/v1.0/h5_payment/partners/%s/orders/%s';
            }else{
                $api_uri ='https://mpay.royalpay.com.au//api/v1.0/alipay/partners/%s/orders/%s';
            }
            ...
            if(!$resArr){
                throw new \Exception('This request has been rejected by the royalpay service!');
            }
