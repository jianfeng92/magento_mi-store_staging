    ...
    public function execute()
    {
        try {
            ...
            if ($this->_quote->getId()) {
                ...
                if (!$this->_quote->getGrandTotal()) {
                    throw new \Magento\Framework\Exception\LocalizedException(
                        __(
                            'Royalpay can\'t process orders with a zero balance due. '
            ...
            if($this->is_wechat_client()){
                $api_uri ='https://mpay.royalpay.com.au/api/v1.0/wechat_jsapi_gateway/partners/%s/orders/%s';
            }else{
                $api_uri ='https://mpay.royalpay.com.au/api/v1.0/gateway/partners/%s/orders/%s';
            }
