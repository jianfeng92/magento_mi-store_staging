...
namespace Lof\FlatRateShipping\Controller\Adminhtml;
...
{ 
    ...
    {
        $resultPage->setActiveMenu('Lof_FlatRateShipping::blacklist')
    ...
    {
        return $this->_authorization->isAllowed('Lof_FlatRateShipping::blacklist');
    } 
