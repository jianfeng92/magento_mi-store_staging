...
class Edit extends \Lof\FlatRateShipping\Controller\Adminhtml\Shipping
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lof_FlatRateShipping::shipping_edit');
    }

    /**
     * Edit FlatRateShipping Form
     *
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Lof\FlatRateShipping\Model\Shipping');
        ...
        $this->_coreRegistry->register('lofflatrateshipping_shipping', $model);  
